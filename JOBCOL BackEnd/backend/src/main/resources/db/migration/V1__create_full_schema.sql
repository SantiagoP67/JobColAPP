...
-- =========================================
-- JOB ASSESSMENTS (Many-to-One con users y offers)
-- =========================================
CREATE TABLE job_assessments (
    ...
    CONSTRAINT fk_assessment_offer
        FOREIGN KEY (offer_id)
        REFERENCES offers(id)
        ON DELETE CASCADE,
...
-- =========================================
-- QUESTIONS (Many-to-One con job_assessments)
-- =========================================
...
-- =========================================
-- ANSWERS (Many-to-One con questions)
-- =========================================
